    ...
    <Shell>
      <section className="px-5 pb-6 pt-10 md:px-7">
        ...
        <p className="mt-3 font-mono text-[11px] text-fg-4">
          components/ui/{e.slug}.tsx · <a href={`https://www.stealth.pm/ui/${e.slug}`} className="underline decoration-line-2 underline-offset-2 transition-colors hover:text-fg-2">docs</a>
        </p>
      </section>
